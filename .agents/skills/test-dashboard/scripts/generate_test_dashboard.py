...
Default output: <repo-root>/tmp/test-dashboard.html
"""
import argparse
import ast
import html
...
DEFAULT_OUT = str(_detect.find_repo_root() / "tmp" / "test-dashboard.html")
...
def main():
    ...
    out_path = _detect.repository_output_path(args.out, "test-dashboard.html")
    _detect.atomic_write_text(out_path, page)
